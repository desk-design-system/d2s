                ...
                <div
                    ...
                    <TransitionChild as="template" enter="dd-ease-out dd-duration-300"
                        ...
                        <DialogPanel :style="{ 'width': modalWidth }"
                            ...
                            <div class="dd-px-4 dd-pt-6 dd-pb-3">
                                <slot name="header">
                                    <div class="dd-flex dd-items-start dd-gap-4">
                                        <div class="dd-flex-shrink-0 dd-h-10 dd-w-10 dd-rounded-full dd-flex dd-items-center dd-justify-center"
                                            :class="conditionalIcons.color">
                                            <component v-if="conditionalIcons" :is="conditionalIcons.icon"
                                                :class="conditionalIcons.class" class="dd-h-6 dd-w-6" aria-hidden="true" />
                                        </div>
                            ...
                            <div class=" dd-flex  dd-flex-shrink-0 dd-justify-end dd-px-6 dd-py-3">
                                <slot name="footer">
                                    <span class="dd-mr-4" v-if="closed">
                                        <rdButton @click="cancel()" color="white" :title="closeTitle" />
                                    </span>
                                    <rdButton v-if="solved" @click="solvedItem()" :color="conditionalIcons.button"
                                        :title="saveTitle" />
                                </slot>
                            </div>
                        </DialogPanel>
