<template>
  <Listbox v-bind="$attrs" as="div" v-model="inputModelValue">
    ...
    <div class="dd-mt-1 dd-relative">
      <ListboxButton
      :class="[hasError ?  ' !dd-border-red-600 focus:!dd-border-red-600 dd-focus:!dd-ring-red-600' : 'dd-border-gray-300 focus:dd-ring-teal-600 focus:!dd-border-teal-600',inputSize  ]"
