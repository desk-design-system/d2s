<template>
  <Switch  v-bind="$attrs" :class="[
    inputModelValue ? 'dd-bg-teal-600' : 'dd-bg-gray-200', size == 'sm' ? 'dd-h-5 dd-w-9 dd-p-0' : 'dd-h-6 dd-w-11 dd-p-0',
  ...
  ]" v-model="inputModelValue" class="dd-relative dd-inline-flex dd-flex-shrink-0 dd-w-11 dd-base">
    <span class="dd-sr-only">Use setting</span>
    <span v-if="size == 'sm'" aria-hidden="true"
      :class="[
      inputModelValue ? 'dd-translate-x-4' : 'dd-translate-x-0', size == 'sm' ? 'dd-h-4 dd-w-4' : 'dd-h-5 dd-w-5',
