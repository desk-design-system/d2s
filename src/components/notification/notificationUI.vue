<template>
  ...
  <div aria-live="assertive" class="dd-pointer-events-none dd-fixed dd-inset-0 dd-flex dd-items-end dd-px-4 dd-py-6 sm:dd-items-start sm:dd-p-6">
    <div class="dd-flex dd-w-full dd-flex-col dd-items-center dd-space-y-4 sm:dd-items-end">
      <!-- Notification panel, dynamically insert this into the live region when it needs to be displayed -->
      <transition enter-active-class="dd-transform dd-ease-out dd-duration-300 dd-transition" enter-from-class="dd-translate-y-2 dd-opacity-0 sm:dd-translate-y-0 sm:dd-translate-x-2" enter-to-class="dd-translate-y-0 dd-opacity-100 sm:dd-translate-x-0" leave-active-class="transition ease-in duration-100" leave-from-class="dd-opacity-100" leave-to-class="dd-opacity-0">
        <div ref="root" v-show="show" class="dd-mt-5 dd-pointer-events-auto dd-w-[350px] dd-overflow-hidden dd-rounded-lg dd-bg-white dd-shadow-lg dd-ring-1 dd-ring-black dd-ring-opacity-5">
          <div class="dd-p-4">
            <div class="dd-flex dd-items-start">
              <div class="dd-flex-shrink-0">
                <component v-if="conditionalIcons" :is="conditionalIcons.icon" :class="conditionalIcons.class" class="dd-h-6 dd-w-6"  aria-hidden="true" />
              ...
              <div class="dd-ml-4 dd-flex dd-flex-shrink-0">
                <button type="button" @click="show = false" class="dd-inline-flex dd-rounded-md dd-bg-white dd-text-gray-400 hover:dd-text-gray-700 ">
