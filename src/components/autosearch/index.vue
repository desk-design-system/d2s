    ...
    >
      <Combobox v-model="inputModelValue">
        <div class="dd-relative">
          ...
          <ComboboxInput
            ...
            :class="[
              ...
              size == 'sx' || size == 'sm' ? 'dd-text-xs' : 'dd-text-sm',
            ]"
        ...
        >
          ...
          >
            <div v-if="loader" class="dd-text-center dd-py-4">
              <svg
                ...
                class="dd-animate-spin dd-fill-teal-600"
                viewBox="0 0 100 101"
                fill="none"
            ...
            >
              <slot name="items" :item="item">
                <li
                  :class="[
                    'dd-cursor-pointer dd-select-none dd-px-4 dd-py-2',
                    active && 'dd-bg-teal-600 dd-text-white',
                  ]"
                >
          ...
          <ComboboxOptions
            class="dd-shadow-md dd-text-center dd-rounded-md"
...
const findItem = (val) => {
  const item = props.options.find(
    (predicate) => predicate[props.defaultProps.value] == val
  );
