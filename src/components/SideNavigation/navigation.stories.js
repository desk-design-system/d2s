...
export default {
  ...
  argTypes: {
    ...
    active: {
      ...
      iconSlot: {
        description: "add custom content in prefix space and it also provide active prop in scoped slot",
        table: {
          defaultValue: {
            summary: Boolean,
          },
      ...
      contentSlot: {
        description: "add custom content in suffix space and it also provide active prop in scoped slot",
        table: {
          defaultValue: {
            summary: Boolean,
          },
